  ...
  return (
    <div>
      ...
      <div className=''>
        ...
        <div className='absolute top-2/3 left-1/2 -translate-x-1/2 -translate-y-1/2 text-black text-center w-[100%] backdrop-blur-[3px] py-5 space-y-4'>
          <h1 className='font-extrabold lg:text-5xl md:text-4xl text-[26px] py-4 text-gray-950 '>Welcome to Nature Care Services</h1>
          <p className='font-bold md:text-2xl text-[18px] italic text-gray-900 '>Where Care Meets Stability.</p>
