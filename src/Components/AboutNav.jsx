    ...
    <div>
      ...
      <div className=''>
        ...
        <div className='lg:flex lg:justify-between lg:space-x-40 lg:px-20 mx-auto lg:py-10 top-0 left-0 right-0 absolute'>
          ...
          <div className='right-24 sm:right-72 md:right-80 top-[110px] absolute lg:hidden'>
          ...
          <div className='lg:items-center lg:pt-4 w-[100%] sm:w-[45%] md:w-[55%]'>
              <ul className={` ${ openMenu ? 'max-h-[600px]' : 'max-h-[0px] lg:max-h-full bg-transparent '} lg:flex lg:gap-5 text-[18px] font-semibold bg-amber-100 lg:bg-transparent w-[100%] pl-4 lg:pl-0 pb-4 text-orange-500 justify-items-center transition-all duration-500 ease-in-out overflow-hidden`}>
                  <li onClick={() => handleTabs(1)} className={`${tab === 1 ? 'text-yellow-600 border-b-[1px] px-1' : 'lg:text-yellow-300'} w-[60px] cursor-pointer hover:text-amber-700 hover:border-b-[1px] pt-4 lg:pt-0 hover:px-1 hover:rounded-sm duration-300 ease-in-out`}><Link to="/">Home</Link></li>
        ...
        <div className='absolute top-2/3 left-1/2 -translate-x-1/2 -translate-y-1/2 text-amber-500 text-center w-[100%]'>
          <h1 className='font-extrabold lg:text-4xl text-2xl py-4'>About Nature Care Services</h1>
