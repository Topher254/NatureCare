      ...
      <div className=''>
        ...
        <div className='flex lg:justify-between lg:space-x-40 lg:px-20 px-10 mx-auto py-10 top-0 left-0 right-0 absolute'>
          ...
          <div className='lg:items-center lg:pt-4 lg:mt-0 mt-16 w-[100%] sm:w-[45%] md:w-[55%]'>
              <ul className={` ${ openMenu ? 'max-h-[600px]' : 'max-h-[0px] lg:max-h-full bg-transparent '} lg:flex lg:gap-5 lg:text-[18px] text-[16px] font-semibold lg:pt-0 pt-4 bg-amber-100 lg:bg-transparent w-[100%] pl-4 lg:pl-0 pb-4 text-orange-500 transition-all duration-500 ease-in-out overflow-hidden`}>
        ...
        <div className='absolute top-2/3 left-1/2 -translate-x-1/2 -translate-y-1/2 text-amber-500 text-center w-[100%]'>
          <h1 className='font-extrabold lg:text-4xl text-2xl py-4'>Welcome to Nature Care Services</h1>
